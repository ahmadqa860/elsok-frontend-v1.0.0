        ...
        <div className="row">
            ...
            <div className="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div className="single_footer_area mb-100">
                    ...
                    <ul className="footer_widget_menu">
                        <li><a href="#"><i className="icofont-rounded-left"></i> Your Account</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Free Shipping Policy</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Your Cart</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Return Policy</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Free Coupon</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Delivary Info</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div className="col-12 col-sm-6 col-md col-lg-4 col-xl-2">
                <div className="single_footer_area mb-100">
                    ...
                    <ul className="footer_widget_menu">
                        <li><a href="#"><i className="icofont-rounded-left"></i> Product Support</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Terms &amp; Conditions</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Help</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Payment Method</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Affiliate Program</a></li>
                        <li><a href="#"><i className="icofont-rounded-left"></i> Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div className="single_footer_area mb-50">
                    ...
                    <div className="subscribtion_form">
                        <form action="#" method="post">
                            <input type="email" name="mail" className="form-control mail" placeholder="Your E-mail Addrees"/>
            ...
            <div className="row align-items-center">
                ...
                <div className="col-12 col-md-6">
                    <div className="copywrite_text">
                        <p>Made with <i className="fa fa-heart" aria-hidden="true"></i> by <a href="#">Designing World</a></p>
                    </div>
                </div>
